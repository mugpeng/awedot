...
- **One-click bookmark** — save any AI session with its API profile, project path, and terminal state
- **Instant resume** — restore a bookmarked session exactly where you left off
- **Floating orb** — a non-intrusive status indicator sitting at your screen edge
- **Search & filter** — full-text search, sort by status / time / tool / project, filter by category
